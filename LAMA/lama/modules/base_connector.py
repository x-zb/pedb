...
ELMO_END_SENTENCE = "</S>"
OPENAI_UNK = "<|endoftext|>" # "<unk>"
OPENAI_EOS = "<|endoftext|>" # "<eos>"
OPENAI_SPACE = chr(288)
ROBERTA_MASK = "<mask>"
...
class Base_Connector():
    ...
    def optimize_top_layer(self, vocab_subset):
        ...
        """
        pass # nothing to do with bert and gpt2
    ...
    def init_indices_for_filter_logprobs(self, vocab_subset, logger=None):
        ...
        return indices, index_list # the indices of vocab_subset's words in the model's tokenizer's vocab

    def filter_logprobs(self, log_probs, indices): # (bsz,seq_len,vocab_size),(subvocab_size)
