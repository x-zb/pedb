...
def run_experiments(
    ...
    for relation in relations:
        ...
        PARAMETERS = {
            ...
            "batch_size": 1 if "SelfDebias" in model_args.prompt_model else 32,
            "logdir": "output",
        ...
        if model is None:
            ...
            model = build_model_by_name(model_type_name, args, model_args, data_args)
...
if __name__ == "__main__":
    ...
    if 'bert' in model_args.model_name_or_path:
        ip = {
            "lm": "bert",
            "label": "bert_base-"+model_args.prompt_model, # bert, fine-tune-bert, adapter-bert are all 'none'
            "models_names": ["bert"],
            "bert_model_name": "bert-base-uncased",
            "bert_model_dir": None # "pre-trained_language_models/bert/cased_L-12_H-768_A-12",
        }
    ...
    run_experiments(*parameters, model_args, data_args, input_param=ip, use_negated_probes=False)
